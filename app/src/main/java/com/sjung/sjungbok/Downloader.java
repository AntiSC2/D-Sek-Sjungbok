...
public class Downloader extends AsyncTask<Void, String, String> {
	...
	private Response login() {
		...
		try {
			res = Jsoup.connect("http://www.dsek.se/navigation/login.php").data("login", "dat11ffo", "password", "x")
	...
	protected void onPostExecute(String result) {
		...
		// borde vi kanske skriva ner vårt resultat till fil redan här? Då kan vi göra
		// allt som ska göras med nedladdning på samam ställe.
		// läs in hela listan, lägg till de nya och sortera det och skriv det sen till
		// disk?
